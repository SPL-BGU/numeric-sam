...
from sam_learning.core.baseline_algorithms_version.naive_convex_hull_learner_no_dependency_removal import NaiveConvexHullLearnerNoDependencyRemoval
...
class NaiveNumericFluentStateStorageNoDependencyRemoval:
    ...
    def __init__(self, action_name: str, domain_functions: Dict[str, PDDLFunction]):
        ...
        self.convex_hull_learner = NaiveConvexHullLearnerNoDependencyRemoval(action_name, domain_functions)
    ...
    def add_to_next_state_storage(self, state_fluents: Dict[str, PDDLFunction]) -> None:
        ...
        for state_fluent_lifted_str, state_fluent_data in state_fluents.items():
            ...
            if len(self.previous_state_storage.get(state_fluent_lifted_str, [])) != len(self.next_state_storage[state_fluent_lifted_str]):
    ...
    def construct_assignment_equations(
        self, allow_unsafe_learning: bool = False, relevant_fluents: Optional[List[str]] = None
