(define (problem pfile1-2-3-3-2-122)
(:domain spider)
; Using 2 decks of cards with 2 suits per deck and 3 values per suit
; 
; Deals
; deal 0: d0-s1-v2 d0-s1-v1 d1-s1-v2
; deal 1: d0-s0-v2 d0-s0-v1 d1-s1-v0
; 
; Initial configuration of piles
; pile 0: d0-s1-v0 d1-s0-v1
; pile 1: d1-s1-v1 d0-s0-v0
; pile 2: d1-s0-v2 d1-s0-v0
(:objects
    card-d0-s0-v0 - card
    card-d0-s0-v1 - card
    card-d0-s0-v2 - card
...
(:init
    (on card-d1-s0-v1 card-d0-s1-v0)
    (on card-d0-s1-v0 pile-0)
    (clear card-d1-s0-v1)
    ...
    (on card-d1-s0-v0 card-d1-s0-v2)
    (on card-d1-s0-v2 pile-2)
    (clear card-d1-s0-v0)
    ...
    (TO-DEAL card-d0-s1-v2 pile-2 deal-0 deal-0)
    (TO-DEAL card-d1-s1-v2 pile-0 deal-0 card-d0-s1-v1)
    (TO-DEAL card-d0-s1-v1 pile-1 deal-0 card-d0-s1-v2)
    (TO-DEAL card-d0-s0-v2 pile-2 deal-1 deal-1)
    (TO-DEAL card-d1-s1-v0 pile-0 deal-1 card-d0-s0-v1)
    (TO-DEAL card-d0-s0-v1 pile-1 deal-1 card-d0-s0-v2)
)
(:goal (and
    (clear pile-0)
    (clear pile-1)
